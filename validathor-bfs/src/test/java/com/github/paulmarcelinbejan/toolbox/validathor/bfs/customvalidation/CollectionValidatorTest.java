package com.github.paulmarcelinbejan.toolbox.validathor.bfs.customvalidation;
...
class CollectionValidatorTest {
	...
	void COLLECTION_NULL() {
		...
		ValidathorException eBFS = assertThrows(ValidathorException.class, () -> ValidathorTestUtils.validateObjectBFS(ferrari, Collections.emptyList(), validathorsParametrizedType));
	...
	void COLLECTION_CAN_BE_NULL() {
		...
		assertDoesNotThrow(() -> ValidathorTestUtils.validateObjectBFS(ferrari, validathors, validathorsParametrizedType));
	}
