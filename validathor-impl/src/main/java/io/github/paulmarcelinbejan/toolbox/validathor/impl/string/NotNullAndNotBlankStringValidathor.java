 ...
 * String is valid if not null and not blank
 */
public class NotNullAndNotBlankStringValidathor extends Validathor<String> {

	public NotNullAndNotBlankStringValidathor() {
		super(String.class);
	}
