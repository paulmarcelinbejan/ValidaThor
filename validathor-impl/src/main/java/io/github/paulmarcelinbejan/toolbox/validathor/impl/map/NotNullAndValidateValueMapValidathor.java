...
public class NotNullAndValidateValueMapValidathor extends ValidathorParameterizedType<Map> {

	public NotNullAndValidateValueMapValidathor(boolean toValidateParameterizedTypeElements) {
