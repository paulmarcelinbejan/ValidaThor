...
public class StringValidator {
	...
	public void validate(final FieldInfo fieldInfo) throws ValidatorException {
	...
	private void isEmpty(final String toValidate, final String toValidateName, final String outerObjectString) throws ValidatorException {
		if(toValidate.isEmpty()) {
			throw new ValidatorException(ExceptionKeys.IS_EMPTY, toValidateName, outerObjectString);
		}
	}
	
	private void isEmptyWhenNotNull(final String toValidate, final String toValidateName, final String outerObjectString) throws ValidatorException {
