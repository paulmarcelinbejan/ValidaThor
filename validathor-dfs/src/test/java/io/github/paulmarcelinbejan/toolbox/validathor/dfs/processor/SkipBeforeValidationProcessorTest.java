...
class SkipBeforeValidationProcessorTest {
	...
	void SKIP_CLASS() {		
		...
		assertDoesNotThrow(() -> ValidathorTestUtils.validateObjectDFS(ferrari, skipBeforeValidationProcessor, new SkipAfterValidationProcessor(), Collections.emptyList(), validathorsParameterizedType));
	}
	...
	void SKIP_MULTI_PACKAGE() {
		...
		assertDoesNotThrow(() -> ValidathorTestUtils.validateObjectDFS(something, skipBeforeValidationProcessor, new SkipAfterValidationProcessor(), Collections.emptyList(), validathorsParameterizedType));
	}
